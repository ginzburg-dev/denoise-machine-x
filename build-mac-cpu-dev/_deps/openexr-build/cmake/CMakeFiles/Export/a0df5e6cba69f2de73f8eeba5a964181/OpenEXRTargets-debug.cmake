...
set_target_properties(OpenEXR::Iex PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libIex-3_2_d.31.3.2.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libIex-3_2_d.31.dylib"
  )

list(APPEND _cmake_import_check_targets OpenEXR::Iex )
list(APPEND _cmake_import_check_files_for_OpenEXR::Iex "${_IMPORT_PREFIX}/lib/libIex-3_2_d.31.3.2.4.dylib" )
...
set_target_properties(OpenEXR::IlmThread PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libIlmThread-3_2_d.31.3.2.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libIlmThread-3_2_d.31.dylib"
  )

list(APPEND _cmake_import_check_targets OpenEXR::IlmThread )
list(APPEND _cmake_import_check_files_for_OpenEXR::IlmThread "${_IMPORT_PREFIX}/lib/libIlmThread-3_2_d.31.3.2.4.dylib" )
...
set_target_properties(OpenEXR::OpenEXRCore PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libOpenEXRCore-3_2_d.31.3.2.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libOpenEXRCore-3_2_d.31.dylib"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRCore )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRCore "${_IMPORT_PREFIX}/lib/libOpenEXRCore-3_2_d.31.3.2.4.dylib" )
...
set_target_properties(OpenEXR::OpenEXR PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libOpenEXR-3_2_d.31.3.2.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libOpenEXR-3_2_d.31.dylib"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXR )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXR "${_IMPORT_PREFIX}/lib/libOpenEXR-3_2_d.31.3.2.4.dylib" )
...
set_target_properties(OpenEXR::OpenEXRUtil PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libOpenEXRUtil-3_2_d.31.3.2.4.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libOpenEXRUtil-3_2_d.31.dylib"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRUtil )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRUtil "${_IMPORT_PREFIX}/lib/libOpenEXRUtil-3_2_d.31.3.2.4.dylib" )
